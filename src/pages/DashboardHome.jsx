...
import { RECENT_PROJECTS, APP_TEMPLATES, TICKETS } from '../lib/data';
        ...
        <div className="flex flex-col gap-6">
             ...
             <div className="section-card">
                ...
                <div className="flex flex-col gap-2">
                    {APP_TEMPLATES.map(t => (
                        <div key={t.id} className="template-item" onClick={() => window.location.href = '/build'}>
                           <div className="text-lg">✨</div>
                           <div className="t-info"><h4>{t.title}</h4><p>{t.desc}</p></div>
                        </div>
                    ))}
                </div>
             </div>
