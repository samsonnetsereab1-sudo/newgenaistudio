...
const BACKEND_TIMEOUT_MS = 30000;  // 30s total backend timeout (respond to browser within this)
const AI_TIMEOUT_MS = 20000;  // 20s max for AI call (increased for domain-heavy prompts)
